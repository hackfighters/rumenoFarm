...
const DogCategoryPage = () => {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" name="description" content="Worried about your dog's joints, digestion, or picky eating? Find powerful dog supplements for every need. Shop Now! 
"/>
        <title>Dog Supplements: Solve Digestion Issues & Boost Overall Health | Dog fiber supplement | dog joint supplement
        </title>
        <link rel="canonical" href="https://www.rumeno.in/veterinary-products/dog-feed-supplements" />
      </Helmet>
