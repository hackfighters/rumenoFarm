...
//                     <Form className="contact_field col-sm-7 pt-1 pb-3">
          ...
          <div className="col-sm-10">
            <div className="contact_inner">
              <div className="row justify-content-between">
                <div className="col-sm-8">
                  <div className="contact_form_inner row justify-content-center">
                    <Form className="contact_field col-sm-7 pt-1 pb-3" onSubmit={handleSubmit(onSubmit)}>
                      <h3 className="my-2 text-center">Contact Us</h3>
                      ...
                      <Form.Group controlId="formMessage">
                        ...
                        />
                        <Form.Control.Feedback type="invalid">{errors.message && errors.message.message}</Form.Control.Feedback>
                      </Form.Group>

                      <button className="contact_form_submit mt-5" type="submit">Send</button>
                    </Form>
                  </div>
                </div>
                <div className="col-md-2">
