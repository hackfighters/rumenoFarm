...
const ProductSidebar = ({ handleClick }) => {
  ...
  const Data = [
    ...
    },
    {
      ...
      Type: "Medicine",
      imgText:
        "Energico Electrolytes for Cattle Goat Poultry Horses Pigs Sheep Pigeon",
    },
    {
      id: 4,
      name: "Energico | Electrolytes for Cattle, Goat, Poultry, Horses, Pigs, Sheep, Pigeons",
