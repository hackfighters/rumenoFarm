...
import { faEye, faHouse, faPerson, faScaleUnbalancedFlip, faTractor, faWheatAwn } from "@fortawesome/free-solid-svg-icons";
  ...
  const FarmEquipment = [
    {
      ...
      description:"Gas fueled Floor Burner is developed for destroying micro bacteria, virus, fungus, hidden parasites, parasites eggs & insect contamination in and around the shed. Flame can be controlled by a knob fitted in the pipe",
      img:farmimg1
    },
    {
      name:"Plastic Slatted Floor",
      price:"Rs. 135 per Square feet + GST + Shipping",
      description:"Size 1 feet X 2 FeetThickness 8mmArea 2 square feet/pieceLoad Capacity up to 100kg (220lbs)Impact & Wear MediumLife more than 5 years ",
      img:farmimg2
    }
  ];
  const RumenoAmazon = [
      ...
      <div className="container-fluid mt-4">
        <div className="row flex-nowrap justify-content-center">
          <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-white rounded">
            <div className="d-flex flex-column align-items-center align-items-sm-start  pt-2 text-white">
              ...
              >
                ...
                >
                  <FontAwesomeIcon className="text-dark h5 mx-2 my-0" icon={faHouse} />
                ...
                >
                  <FontAwesomeIcon className="text-dark h5 mx-2 my-0" icon={faTractor} />
                  <span className="ms-1 d-none d-sm-inline text-dark">
                    farmhouse Equipment
                  </span>
                </li>
                <li
                  ...
                  className="sildar my-3 ms-2"
                >
                  <FontAwesomeIcon className="text-dark h5 mx-2 my-0" icon={faAmazon} />
                  <span className="ms-1 d-none d-sm-inline text-dark">
                    Rumeno with Amazon
                  </span>
                </li>
                <li
                  ...
                  className="sildar my-3 ms-2"
                >
                  <FontAwesomeIcon className="text-dark h5 mx-2 my-0" icon={faPerson} />
                  <span className="ms-1 d-none d-sm-inline text-dark">
                    Human Consumable
                  </span>
                </li>
                <li
                  ...
                  className="sildar my-3 ms-2"
                >
                  <FontAwesomeIcon className="text-dark h5 mx-2 my-0" icon={faWheatAwn} />
                  <span className="ms-1 d-none d-sm-inline text-dark">
                    Crop Seeds
                  </span>
                </li>
                <li
                  ...
                  className="sildar my-3 ms-2"
                >
                  <FontAwesomeIcon className="text-dark h5 mx-2 my-0" icon={faScaleUnbalancedFlip} />
                  <span className="ms-1 d-none d-sm-inline text-dark">
                    Goats for Sale
                  </span>
                </li>
          ...
          <div className="col-md-10 product-sect p-3">
                  ...
                  <div className="bg-light h-50 rounded text-dark bg-opacity-50 p-2">
                    <div className="row d-flex px-3">
                      ...
                      <div className="col-sm-9 p-2 ps-5">
                        ...
                        <FontAwesomeIcon className="mx-2 my-3 h3 text-primary" type="button" icon={faYoutube} beat />
                        <FontAwesomeIcon className="mx-2 my-3 h3 text-primary" type="button" icon={faEye} beat />
            ...
            {farmhouseequip &&  Farmequip.map((f,index)=>(
              <div className="col py-1" key={index}>
              <div className="bg-light h-50 rounded text-dark bg-opacity-50 p-2">
                <div className="row d-flex px-3">
                  <div className="col-sm-3 p-2">
                    <img src={f.img} alt="Loading" width={200} />
                  </div>
                  <div className="col-sm-9 p-2 ps-5">
            ...
            {rumenoamazon &&  RumenoAmazon.map((r,index)=>(
              <div className="col py-1" key={index}>
              <div className="bg-light h-50 rounded text-dark bg-opacity-50 p-2">
                <div className="row d-flex px-3">
                  <div className="col-sm-3 p-2">
            ...
            {humanconsumable &&  HumanConsumable.map((r,index)=>(
              <div className="col py-1" key={index}>
              <div className="bg-light h-50 rounded text-dark bg-opacity-50 p-2">
                <div className="row d-flex px-3">
                  <div className="col-sm-3 p-2">
            ...
            {goatforsale &&  GoatForSale.map((r,index)=>(
              <div className="col py-1" key={index}>
              <div className="bg-light h-50 rounded text-dark bg-opacity-50 p-2">
                <div className="row d-flex px-3">
                  <div className="col-sm-3 p-2">
