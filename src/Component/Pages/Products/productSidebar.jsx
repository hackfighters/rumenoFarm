...
const ProductSidebar = ({ handleClick }) => {
  ...
  return (
    <div className="container-fluid mt-4">
      ...
      <div className="row flex-nowrap justify-content-center ms-0 mx-md-4 mx-lg-0">
        <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-white rounded h-100">
          <div className="d-flex flex-column align-items-center align-items-sm-start pt-2 text-white w-100">
            ...
            >
              <li
                className={`nav-item sildar py-1  w-100 ${category === "animal" ? "active" : ""
                  }`}
              ...
              <li
                className={`sildar py-1  w-100 ${category === "farmhouseequip" ? "active" : ""
                  }`}
              ...
              <li
                className={`sildar py-1  w-100 ${category === "rumenoamazon" ? "active" : ""
                  }`}
              ...
              <li
                className={`sildar py-1  w-100 ${category === "humanconsumable" ? "active" : ""
                  }`}
              ...
              <li
                className={`sildar py-1  w-100 ${category === "goatforsale" ? "active" : ""
                  }`}
      ...
      <p>Welcome to our online store, where we provide a wide selection of veterinary products to guarantee the health of your cherished pets. We have everything you need, whether you have a curious cat, a devoted dog, or a feathered buddy.</p>
      <hr />
