              ...
              <div class="d-flex  py-2 align-items-center ">
                <div class="flex-grow-1 my-2">
                  ...
                  <div class="text-muted mb-3 mx-2">
                    {/* {showBlog?.content} */}
              <div className='text-trun-blog' dangerouslySetInnerHTML={{ __html: showBlog?.content }} />
                  </div>
                  {showBlog?.keywords.map((keyword,index) =>(
                <ul key={index} className="list-unstyled d-flex mb-0">
                  <li class="me-3 fw-bold text-primary">{keyword}</li>
                </ul>
                  ))}
