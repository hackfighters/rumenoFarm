...
const ServicesThird = () => {
    ...
    <section className="container-fluid service-bg overflow-hidden">
      ...
      <div className="col-lg-12">
        ...
        <p className="mx-5 my-4">
          Dairy consultants in India can turn to Rumeno Farmotech, a
          trailblazing name in the field of agricultural consulting. Rumeno
          Farmotech provides a range of services that are designed to maximize
          the administration of dairy farms. The company has a track record of
          providing customized solutions. By utilizing state-of-the-art
          technologies and seasoned knowledge, they enable farmers throughout
          India to increase yield, strengthen the health of their herds, and
          optimize profits. Rumeno Farmotech is dedicated to fostering
          revolutionary growth in the Indian dairy sector, from strategic
          planning to practical assistance, and establishing new benchmarks
          for excellence for dairy consultants across the country.
        </p>
        <p className="mx-5 my-4">
  ...
  <img src={service7} width={450} height={400} alt="loading" />
          </div>
        </div>
      </div>
      <div className="col-lg-12">
        ...
        <p className="mx-5 my-4">
          ...
          from feed optimization to herd health management.
        </p>
        <p className="mx-5 my-4">
      ...
      <div className="col-lg-12 d-flex justify-content-evenly">
          <img className="" width={400} height={400} src={service6} alt="loading" />
          <img className="" width={400} height={400} src={service5} alt="loading" />
          <img className="" width={400} height={400} src={service8} alt="loading" />
      </div>
