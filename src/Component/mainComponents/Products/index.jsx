...
const Products = () => {
  ...
  const givenValue = "Mukti"; // Replace with your desired value to match against
  const InputValue = "Mdukti"; // Replace with your desired value to match against
                ...
                <div className="card-box py-4">
                  <div className="card1">
                    ...
                    <div className="card-body-products">
                      <h1 className="card-title-products">{product.name}</h1>
                      <p className="card-sub-title-products">
                        Rs. {product.price} /-
                      </p>
                      <div className="d-flex justify-content-between pt-3">
                        ...
                        <div>
                          <button
                            className="card-btn" value={InputValue}
                      ...
                      <div className="pt-3">
                        <button className="card-btn">YouTube</button>
                      </div>
                    </div>
                  </div>
                </div>
