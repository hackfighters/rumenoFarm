            ...
            <div className="card profile-two">
              ...
              <ul className="social-icons p-0">
                <li>
                  ...
                  onHide={handleClose}
                  aria-labelledby={`${card2.name}ModalLabel`}
                  centered
                  size="xl"
                >
                  <Modal.Header id={`${card2.name}ModalLabel`} closeButton>
                    ...
                    <div className="container">
                      <div className="row">
                        ...
                        <div className="col-lg-6 modal-txt">
                          <h5 className="fw-bolder">{card2.txt1}</h5>
                          <p>{card2.txt2}</p>
                          <h5 className="fw-bolder">{card2.txt3}</h5>
                          <p>{card2.txt4}</p>
                          <h5 className="fw-bolder">{card2.txt5}</h5>
                          <p>{card2.txt6}</p>
                          <p>{card2.txt7}</p>
                          <p>{card2.txt8}</p>
                          <p>{card2.txt9}</p>
                          <h5 className="fw-bolder">{card2.txt10}</h5>
                          <p>{card2.txt11}</p>
                          <h5 className="fw-bolder">{card2.txt12}</h5>
                          <p>{card2.txt13}</p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="details jane">
                <h2 >
                  {card2.name}
                  <span className="job-title d-block">{card2.price}</span>
                </h2>
              </div>
            </div>
          </div>
