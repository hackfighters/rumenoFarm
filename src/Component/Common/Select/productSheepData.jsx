  ...
  const PrdData3 = [
    {
      ...
      oldprice: "₹10:00",
      img: Prdimg7,
      txt1: "Goat & Sheep milk feeding nipples",
      txt2: "Goat and sheep milk feeding nipples with a bottle cap are a versatile and convenient option for farmers and breeders who want to feed their young animals with ease. These nipples are specially designed to fit on any standard Pepsi or Cola size bottle, making it easy to create a makeshift feeding bottle with materials that are readily available.",
      txt3: "",
      txt4: "The bottle cap design allows the nipple to be easily screwed onto the top of the bottle, creating a secure and leak-proof seal. This makes it easy to transport and use the feeding bottle without worrying about spills or leaks.",
      txt5: "",
      txt6: "Using goat and sheep milk feeding nipples with a bottle cap can help to reduce the cost and hassle of traditional feeding equipment. It eliminates the need for expensive bottles and special equipment, making it a cost-effective option for farmers and breeders.",
      txt7: "Furthermore, these feeding nipples can help to promote healthy digestion and reduce the risk of bloating or other digestive issues in young animals. They allow the young animals to feed at their own pace and encourage them to use a natural feeding position, promoting optimal digestion and nutrient absorption.",
      txt8: "Overall, goat and sheep milk feeding nipples with a bottle cap are a convenient, cost-effective, and safe option for farmers and breeders who want to provide the best possible care for their young animals. Whether you're raising a few goats or sheep in your backyard or managing a large commercial operation, these nipples are an essential tool for feeding and caring for your animals.",
      txt9: "",
      txt10: "",
      txt11:
        "",
    ...
    },
    {
      ...
      oldprice: "₹10:00",
      img: Prdimg8,
      txt1: "Pro-Lac Power Goat & Sheep Milk Replacer",
      txt2: "Introducing Pro-Lac Power Goat & Sheep Kids Milk Replacer, the ultimate solution for nourishing and supporting the growth of your young goats and sheep. With a unique formula that boasts of 35% easy digestible proteins and essential nutrients, our milk replacer is the perfect choice for ensuring the complete health and wellbeing of your kids.",
      txt3: "",
      txt4: "Pro-Lac Power Goat & Sheep Milk replacer is beneficial for sheep and goat kids when they are unable to receive sufficient or adequate milk from their mothers. There are several reasons why milk replacer may be necessary for the health and wellbeing of young kids:",
      txt5: "In summary, Pro-Lac Power Goat & Sheep Milk Replacer is important for kids because it provides essential nutrients that are necessary for their growth and development. It is a safe, convenient, and effective way to ensure that your kids are receiving the optimal nutrition they need for a healthy and happy life.",
      txt6: "",
      txt7: "",
      txt8: "",
      txt9: "",
            ...
            <div className="card profile-two">
              ...
              <ul className="social-icons p-0">
                <li>
                  ...
                  onHide={handleClose}
                  aria-labelledby={`${card3.name}ModalLabel`}
                  centered
                  size="xl"
                >
                  <Modal.Header id={`${card3.name}ModalLabel`} closeButton>
                    ...
                    <div className="container">
                      <div className="row">
                        ...
                        <div className="col-lg-6 modal-txt">
                          <h5 className="fw-bolder">{card3.txt1}</h5>
                          <p>{card3.txt2}</p>
                          <h5 className="fw-bolder">{card3.txt3}</h5>
                          <p>{card3.txt4}</p>
                          <h5 className="fw-bolder">{card3.txt5}</h5>
                          <p>{card3.txt6}</p>
                          <p>{card3.txt7}</p>
                          <p>{card3.txt8}</p>
                          <p>{card3.txt9}</p>
                          <h5 className="fw-bolder">{card3.txt10}</h5>
                          <p>{card3.txt11}</p>
                          <h5 className="fw-bolder">{card3.txt12}</h5>
                          <p>{card3.txt13}</p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="details jane">
                <h2 >
                  {card3.name}
                  <span className="job-title d-block">{card3.price}</span>
                </h2>
              </div>
            </div>
          </div>
