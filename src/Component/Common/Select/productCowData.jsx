        ...
        >
          <div className="product-item pdt-card pdt-card-img">
            ...
            <div className="text-center p-0 pdt-detl pdt-card-txt">
              ...
              <span className="text-primary me-1 job-title">{card1.price}</span>
              <span className="text-body text-decoration-line-through">
                {card1.oldprice}
              </span>
            </div>
            <div className="d-flex  pdt-card-button w-75">
              ...
              <small className="w-50 text-center py-2 pdt-card-button-txt">
