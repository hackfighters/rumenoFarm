        ...
        >
          <div className="product-item">
            <div className="position-relative bg-light overflow-hidden">
              ...
              {/* <div className="bg-success text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                        New
                      </div> */}
            </div>
            <div className="text-center p-4">
              <a className="d-block h4 mb-2 fw-bold text-decoration-none" href="# ">
                {card1.name}
              </a>
              <span className="text-primary me-1">{card1.price}</span>
              
            </div>
            <div className="d-flex border-top card-detail">
              <small className="w-50 text-center border-end py-2">
                <a
                  className="text-body" href="# "
              ...
              <small className="w-50 text-center py-2">
                ...
                >
                  <Modal.Header id={`${card1.name}ModalLabel`} closeButton>
                    <h1 className="fw-bolder w-25 me-5 ms-5 text-none">.</h1>
                    <h1 className="fw-bolder me-5 text-none">.</h1>
                    <Modal.Title id="example-modal-sizes-title-lg w-50 text-center">
                      <h1 className="fw-bolder">{card1.name}</h1>
                    </Modal.Title>
                  </Modal.Header>
                  <Modal.Body>
                    <div className="container">
                      <div className="row justify-content-center">
                        <div className="col-lg-5">
                          <img className="border rounded" alt="" src={card1.img} />
                        </div>
                        <div className="col-lg-6 modal-txt">
                          <h5 className="fw-bolder">{card1.txt1}</h5>
                          <p className="text-secondary">{card1.txt2}</p>
                          <h5 className="fw-bolder">{card1.txt3}</h5>
                          <p className="text-secondary">{card1.txt4}</p>
                          <h5 className="fw-bolder">{card1.txt5}</h5>
                          <p className="text-secondary">{card1.txt6}</p>
                          <p className="text-secondary">{card1.txt7}</p>
                          <p className="text-secondary">{card1.txt8}</p>
                          <p className="text-secondary">{card1.txt9}</p>
                          <h5 className="fw-bolder">{card1.txt10}</h5>
                          <p className="text-secondary">{card1.txt11}</p>
                          <h5 className="fw-bolder">{card1.txt12}</h5>
                          <p className="text-secondary">{card1.txt13}</p>
                        </div>
                      </div>
                    </div>
                  </Modal.Body>
            ...
            <div className="d-flex border-top card-detail">
              <small className="w-100 text-center border-end py-2">
                <a
                  ...
                  onClick={() => setModalId(`modal${i}`)}
                >
                  <i className="fa-brands fa-youtube text-primary me-2"></i>
                  YouTube Link
                </a>
              </small>
            </div>
