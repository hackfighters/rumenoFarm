                        ...
                        <div className='row justify-content-center bg-white  lg:mx-5 mx-0 py-2'>
                            ...
                            <div className="col-lg-5 offset-lg-1">
                                ...
                                <div className='row  my-3 ' >
                                    {aa.map((item) => (
                                        <Link className='col-lg-2 m-2 py-1 border border-danger border-2 d-grid rounded px-3 w-auto text-center text-decoration-none' to={`/veterinary-products/ProductDetail/${item.id}/${item.imgText.replace(/ /g, '-')}`}>
                                            <div className=''>
